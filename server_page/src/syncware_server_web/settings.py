"""
Django settings for syncware_server_web project.
...
import os
from frontend_b.views import index
...
SECRET_KEY = '!^4@x@$g4kn_ere$$rcvy6b2np1rb(%_m+v_x^t=#tl-5a#-_l'
...
ROOT_URLCONF = 'syncware_server_web.urls'
